 ...
 *
 * NB: Files called index.js are treated specially in that they handle the endpoint for their
            ...
            if (path.extname(filepath) == '.js') {
                ...
                if (util.isNullOrUndefined(epModule.REL)
                 ...
                 || util.isNullOrUndefined(epModule.CALLBACK)) {
                    ...
                    log.warn(`Javascript source file ${filepath} does not define an endpoint`);
                    return;
                }
