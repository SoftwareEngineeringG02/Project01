...
module.exports.init = function(config) {
    log.trace(module, module.exports.init);
...
module.exports.getLocation = function(id) {
    log.trace(module, module.exports.getLocation);
 ...
 */
module.exports.setLocation = function(id, time, longitude, latitude) {
